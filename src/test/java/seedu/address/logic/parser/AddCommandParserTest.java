...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + YEAR_DESC_BOB
                + STUDENT_NUMBER_DESC_BOB + EMAIL_DESC_BOB + PHONE_DESC_BOB + DIETARY_DESC_BOB
        ...
        Person expectedPersonMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
        assertParseSuccess(parser, NAME_DESC_BOB + YEAR_DESC_BOB + STUDENT_NUMBER_DESC_BOB
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        assertParseFailure(parser,
                ...
                Messages.getErrorMessageForDuplicatePrefixes(
                        PREFIX_NAME, PREFIX_YEAR, PREFIX_STUDENT_NUMBER, PREFIX_EMAIL,
                        PREFIX_PHONE, PREFIX_DIETARY, PREFIX_ROLE));
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser,
                NAME_DESC_AMY + YEAR_DESC_AMY + STUDENT_NUMBER_DESC_AMY + EMAIL_DESC_AMY
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing year prefix
        assertParseFailure(parser,
                NAME_DESC_BOB + VALID_YEAR_BOB + STUDENT_NUMBER_DESC_BOB + EMAIL_DESC_BOB
                        + PHONE_DESC_BOB + DIETARY_DESC_BOB + ROLE_DESC_BOB,
                expectedMessage);

        // missing student number prefix
        assertParseFailure(parser,
                NAME_DESC_BOB + YEAR_DESC_BOB + VALID_STUDENT_NUMBER_BOB + EMAIL_DESC_BOB
                        + PHONE_DESC_BOB + DIETARY_DESC_BOB + ROLE_DESC_BOB,
                expectedMessage);

        // missing email prefix
        assertParseFailure(parser,
                NAME_DESC_BOB + YEAR_DESC_BOB + STUDENT_NUMBER_DESC_BOB + VALID_EMAIL_BOB
                        + PHONE_DESC_BOB + DIETARY_DESC_BOB + ROLE_DESC_BOB,
                expectedMessage);

        // missing phone prefix
        assertParseFailure(parser,
                NAME_DESC_BOB + YEAR_DESC_BOB + STUDENT_NUMBER_DESC_BOB + EMAIL_DESC_BOB
        ...
        assertParseFailure(parser,
                VALID_NAME_BOB + VALID_YEAR_BOB + VALID_STUDENT_NUMBER_BOB + VALID_EMAIL_BOB
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser,
                INVALID_NAME_DESC + YEAR_DESC_BOB + STUDENT_NUMBER_DESC_BOB + EMAIL_DESC_BOB
                        + PHONE_DESC_BOB + DIETARY_DESC_BOB + ROLE_DESC_BOB
        ...
        // invalid year
        assertParseFailure(parser,
                NAME_DESC_BOB + INVALID_YEAR_DESC + STUDENT_NUMBER_DESC_BOB + EMAIL_DESC_BOB
                        + PHONE_DESC_BOB + DIETARY_DESC_BOB + ROLE_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
        ...
        assertParseFailure(parser,
                NAME_DESC_BOB + YEAR_DESC_BOB + INVALID_STUDENT_NUMBER_DESC + EMAIL_DESC_BOB
                        + PHONE_DESC_BOB + DIETARY_DESC_BOB + ROLE_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
        ...
        // invalid email
        assertParseFailure(parser,
                NAME_DESC_BOB + YEAR_DESC_BOB + STUDENT_NUMBER_DESC_BOB + INVALID_EMAIL_DESC
                        + PHONE_DESC_BOB + DIETARY_DESC_BOB + ROLE_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
        ...
        assertParseFailure(parser,
                NAME_DESC_BOB + YEAR_DESC_BOB + STUDENT_NUMBER_DESC_BOB + EMAIL_DESC_BOB
                        + INVALID_PHONE_DESC + DIETARY_DESC_BOB + ROLE_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
        ...
        assertParseFailure(parser,
                NAME_DESC_BOB + YEAR_DESC_BOB + STUDENT_NUMBER_DESC_BOB + EMAIL_DESC_BOB
                        + PHONE_DESC_BOB + DIETARY_DESC_BOB + INVALID_ROLE_DESC
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
        ...
        // non-empty preamble
        assertParseFailure(parser,
                PREAMBLE_NON_EMPTY + NAME_DESC_BOB + YEAR_DESC_BOB + STUDENT_NUMBER_DESC_BOB
                        + EMAIL_DESC_BOB + PHONE_DESC_BOB + DIETARY_DESC_BOB + ROLE_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,

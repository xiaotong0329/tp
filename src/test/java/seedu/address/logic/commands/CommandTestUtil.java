...
public class CommandTestUtil {
    ...
    public static final String VALID_STUDENT_NUMBER_AMY = "A1234567X";
    public static final String VALID_STUDENT_NUMBER_BOB = "B2345678Y";
    public static final String VALID_EMAIL_AMY = "amy@example.com";
    public static final String VALID_EMAIL_BOB = "bob@example.com";
    public static final String VALID_PHONE_AMY = "11111111";
    public static final String VALID_PHONE_BOB = "22222222";
    public static final String VALID_DIETARY_AMY = "Vegetarian";
    public static final String VALID_DIETARY_BOB = "No restrictions";
    public static final String VALID_ROLE_AMY = "Member";
    public static final String VALID_ROLE_BOB = "President";
    ...
    public static final String DIETARY_DESC_AMY = " " + PREFIX_DIETARY + VALID_DIETARY_AMY;
    public static final String DIETARY_DESC_BOB = " " + PREFIX_DIETARY + VALID_DIETARY_BOB;
    ...
    public static final String INVALID_ROLE_DESC = " " + PREFIX_ROLE + "Role&"; // '&' not allowed in roles
    public static final String INVALID_TAG_DESC = " " + PREFIX_TAG + "hubby*"; // '*' not allowed in tags

    // Legacy address constants for backward compatibility
    public static final String VALID_ADDRESS_AMY = "Block 312, Amy Street 1";
    public static final String VALID_ADDRESS_BOB = "Block 123, Bobby Street 3";
    public static final String ADDRESS_DESC_AMY = " " + PREFIX_DIETARY + VALID_ADDRESS_AMY;
    public static final String ADDRESS_DESC_BOB = " " + PREFIX_DIETARY + VALID_ADDRESS_BOB;
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_DIETARY + ""; // empty string not allowed

    public static final String DESC_AMY = NAME_DESC_AMY + YEAR_DESC_AMY + STUDENT_NUMBER_DESC_AMY + EMAIL_DESC_AMY
            + PHONE_DESC_AMY + DIETARY_DESC_AMY + ROLE_DESC_AMY;
    public static final String DESC_BOB = NAME_DESC_BOB + YEAR_DESC_BOB + STUDENT_NUMBER_DESC_BOB + EMAIL_DESC_BOB

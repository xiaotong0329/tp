...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                INVALID_NAME, VALID_YEAR, VALID_STUDENT_NUMBER, VALID_EMAIL,
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                null, VALID_YEAR, VALID_STUDENT_NUMBER, VALID_EMAIL,
                VALID_PHONE, VALID_DIETARY, VALID_ROLE, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_YEAR, VALID_STUDENT_NUMBER, VALID_EMAIL,
                INVALID_PHONE, VALID_DIETARY, VALID_ROLE, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_YEAR, VALID_STUDENT_NUMBER,
                INVALID_EMAIL, VALID_PHONE, VALID_DIETARY, VALID_ROLE, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_YEAR, VALID_STUDENT_NUMBER,
                null, VALID_PHONE, VALID_DIETARY, VALID_ROLE, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_YEAR, VALID_STUDENT_NUMBER,
                VALID_EMAIL, VALID_PHONE, INVALID_DIETARY, VALID_ROLE, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_YEAR, VALID_STUDENT_NUMBER,
                VALID_EMAIL, VALID_PHONE, null, VALID_ROLE, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_YEAR, VALID_STUDENT_NUMBER, VALID_EMAIL,
                VALID_PHONE, VALID_DIETARY, VALID_ROLE, invalidTags);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
